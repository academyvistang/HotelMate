...
namespace Invoicer.Services.Impl
{
    public partial class PdfInvoice
    {
        ...
        private void BillingHeaderCheckout(Table table)
        {
            ...
            row.Cells[1].AddParagraph("DETAIL", ParagraphAlignment.Center);
            row.Cells[2].AddParagraph("CREDIT", ParagraphAlignment.Center);
            row.Cells[3].AddParagraph("DEBIT", ParagraphAlignment.Center);
            row.Cells[4].AddParagraph("BALANCE", ParagraphAlignment.Center);
        ...
        private void BillingRowCheckout(Table table, ItemRow item)
        {
            ...
            cell.AddParagraph(item.TransactionDate.ToShortDateString(), ParagraphAlignment.Left, "H2-9B");
            ...
            cell = row.Cells[2];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.Credit.ToCurrency(), ParagraphAlignment.Center, "H2-9");

            cell = row.Cells[3];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.Debit.ToCurrency(strCurrency), ParagraphAlignment.Center, "H2-9");
            ...
            else
            {
                cell = row.Cells[4];
                cell.VerticalAlignment = VerticalAlignment.Center;
                cell.AddParagraph(item.Balance.ToCurrency(strCurrency), ParagraphAlignment.Center, "H2-9");
            }
        }
        ...
        private void BillingRow(Table table, ItemRow item)
        {
            ...
            cell = row.Cells[3];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.Price.ToCurrency(strCurrency), ParagraphAlignment.Center, "H2-9");
