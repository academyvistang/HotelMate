...
function ci_add_cpt_slider_meta_box()
{
	...
	?>
	<p><?php _e( 'Assign a Featured Image for this slider item, so that it appears on the home page slider. Also, set a URL below to redirect the user, when the "Read More" button gets clicked. Leaving the URL blank, will redirect to the slider\'s own content.', 'ci_theme' ); ?></p>
