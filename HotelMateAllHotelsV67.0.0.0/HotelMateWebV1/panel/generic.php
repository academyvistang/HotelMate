...
/**
 * Echoes a discounthotelmotels setting.
 * 
 * @access public
...
/**
 * Returns a discounthotelmotels setting, or boolean FALSE on failure.
 * 
 * @access public
 * @param string $setting
 * @return string|false
...
/**
 * Returns the discounthotelmotels logo snippet, either text or image if available.
 * 
 * @access public
...
/**
 * Echoes the discounthotelmotels logo snippet, either text or image if available.
 * 
 * @access public
 * @param string $before Text or tag before the snippet.
 * @param string $after Text or tag after the snippet.
...
/**
 * Returns the discounthotelmotels slogan snippet, surrounded by optional strings.
...
/**
 * Echoes the discounthotelmotels slogan snippet, surrounded by optional strings.
...
/**
 * Returns the footer text, set from the discounthotelmotels panel.
 * 
 * @access public
...
function ci_theme_update_check()
{
	...
	$versions_url = apply_filters('ci_theme_update_url', 'http://www.academyvista.com/theme_versions.json');	
