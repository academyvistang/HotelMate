...
<?php
	...
	$ci_defaults['social_twitter_url'] 		= 'http://twitter.com/discounthotelmotels';
...
*/
	...
	$ci_defaults['social_facebook_url'] 	= 'http://www.facebook.com/discounthotelmotels';
	...
	$ci_defaults['social_wordpress_text']	= __('Visit our Leboston.com blog', 'ci_theme');
