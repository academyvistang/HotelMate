...
<?php
	...
	function ci_check_seo_plugin()
	{
		$plugins = array(
			...
			'get_wpseo_options' => 'YOAST Leboston SEO',
			...
			'zeo_rewrite_title' => 'SEO Leboston'
		);
	...
	<fieldset class="set">
		<p class="guide">
			<?php echo 
				...
				__('"<b>Use pure Leboston function</b>" should only be used if you have a SEO plugin installed that isn\'t detected, and the plugin\'s documentation suggests to change the title tag function to <b>wp_title(\'\');</b> . In that case, you don\'t need to edit any files, just select this option.', 'ci_theme');
			?>
		</p>
		<p class="guide">
			<?php 
		...
		<fieldset>
			...
			<?php ci_panel_radio('use_ci_head_title', 'use_wp_title', 'disabled', __('Use pure Leboston function ( wp_title(\'\') )', 'ci_theme')); ?>
		</fieldset>
