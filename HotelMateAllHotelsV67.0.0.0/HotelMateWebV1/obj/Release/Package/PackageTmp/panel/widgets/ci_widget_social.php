...
class CI_Social extends WP_Widget {
	...
	function form($instance){
		...
		echo "<p>" . sprintf(__('This widget is a placeholder for Social Media icons. You may configure those icons from the <a href="%s">discounthotelmotels\'s panel</a>, under the <strong>Social Options</strong> tab.', 'ci_theme'), 'themes.php?page=ci_panel.php') . "</p>";
