...
function ci_enqueue_admin_scripts() 
{
	...
	{
		//
		// Enqueue here scripts and styles that are to be loaded only on discounthotelmotels Settings panel.
		//
		global $wp_version;
...
function ci_create_menu() {
	...
	if(!CI_WHITELABEL)
		$menu_title = __('discounthotelmotels Settings', 'ci_theme');
	else
...
//
//
// discounthotelmotels panel control generators
//
//
